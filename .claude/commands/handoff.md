...
3. მხოლოდ თუ **phase / sprint დაიხურა**:
   ...
   - `PLAN.md` — ახალი row closed-milestone ცხრილში
...
- 🚫 არ წაიკითხო `PLAN.md` / `PHASE_STATUS_MATRIX.md` / `HANDOFF.md` / `AI_GENIUS_PARTNER_PLAN.md` თუ task-ი მათ არ სჭირდება — CONTEXT_HANDOFF.md-ში ყველაფერი მოკლედაა
- 🚫 არ დატოვო broken state
- 🚫 არ განაახლო `HANDOFF.md` / `PLAN.md` / `PHASE_STATUS_MATRIX.md` session history-თი — მათი role სხვაა (pointer / closed-milestone log / phase overview)
