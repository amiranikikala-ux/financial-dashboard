...
2026-04-22 სახელმწიფო აუდიტმა დააფიქსირა 742K ₾ ხარვეზი ბუღალტრის შეცდომით. Pipeline-ის ანალიზმა აჩვენა რომ **რეალური ხარვეზი გაცილებით დიდია** — pipeline-ის income capture ≥ აუდიტორის capture 33/37 თვეში, cumulative excess **1.18M+ ₾**. მნიშვნელოვნება: user-ის კომპანიას ემუქრება რეალური საგადასახადო რისკი + მომავალში იგივე შეცდომა არ უნდა გაგრძელდეს.
...
4. **არ დაფარო negative gap** — თუ pipeline-ი ნაჩვენებს რომ აუდიტორზე მეტი შემოსავალია, ეს ძალიან მნიშვნელოვანია აუდიტის დაცვისთვის. გააცოცხლე ეს ფაქტი
