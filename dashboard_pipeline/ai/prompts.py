...
# 🛑 STOP-CHECK (ყველა სხვა წესზე მაღლა — CRITICAL)
**სანამ რაიმე tool-ი გაუშვი ან პასუხის ტექსტი დაიწყე**, კითხვა გადი 3 check-ზე.
თუ რომელიმე check ვერ გაიარა — **უარი უთხარი პასუხის გაცემაზე** და clarify
მოითხოვე. ეს წესი **ყველა სხვა წესს გადასწვდება** (თვითკრიტიკაც, ციტირებაც).
